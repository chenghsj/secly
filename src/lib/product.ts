...
export const LEGACY_APP_SLUG = 'gh-vardeck'
export const CLI_NAME = 'secly'
export const LEGACY_CLI_NAME = 'ghdeck'
...
export const LEGACY_THEME_STORAGE_KEY = `${LEGACY_APP_SLUG}:theme`
export const LEGACY_LOCALE_STORAGE_KEY = `${LEGACY_APP_SLUG}:locale`

export const APP_DATA_ROOT_DISPLAY = `~/Library/Application Support/${APP_SLUG}`
export const LEGACY_APP_DATA_ROOT_DISPLAY = `~/Library/Application Support/${LEGACY_APP_SLUG}`
export const CLI_LINK_DISPLAY = `~/.local/bin/${CLI_NAME}`
export const LEGACY_CLI_LINK_DISPLAY = `~/.local/bin/${LEGACY_CLI_NAME}`
